...
router = APIRouter(
    prefix="/campaigns/{campaign_id}/stations/{station_id}/sensors/{sensor_id}/notes",
    tags=["notes"],
)
...
def create_sensor_note(
    ...
    return service.create_sensor_note(request, campaign_id, station_id, sensor_id, current_user.username)
