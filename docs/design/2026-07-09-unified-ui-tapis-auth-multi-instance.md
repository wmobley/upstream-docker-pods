...
**Deviations from the pre-2026-07-17 design:** none beyond what's already captured in the 2026-07-17 Decisions above (dropdown grouping source switched from Tapis pod permission to DB `user_roles`; NONE-role projects hidden; dev-bypass hardening added; CORS/token-fan-out and role-staleness accepted as documented risks rather than fixed).
